 ...
 * Area
 *
 * @ORM\Table(name="nomencladores.area", indexes={@ORM\Index(name="IDX_D3D33F58F3E6D02F", columns={"unidad"})})
 * @ORM\Entity(repositoryClass="Geocuba\PortadoresBundle\Repository\AreaRepository")
 */
class Area
{
    /**
