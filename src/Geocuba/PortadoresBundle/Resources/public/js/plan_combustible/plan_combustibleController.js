Ext.onReady(function () {
    ...
    var storeTc = Ext.create('Ext.data.JsonStore', {
    ...
    var edit = new Ext.grid.plugin.CellEditing({
        ...
        listeners: {
            beforeedit: function (This, e, eOpts) {
                ...
                //if ((e.colIdx > 7 && (e.colIdx < App.current_month *  ncolanteriores  )) || isNaN(e.value)) {
                //    return false;
                //}
                // if (e.colIdx > 7 && (e.colIdx < (App.current_month - 1) * nindicador + ncolanteriores  ) || isNaN(e.value)) {

                if ((e.colIdx > 8 && e.colIdx < 16) || isNaN(e.value) ) {
            ...
            edit: function (This, e, eOpts) {
                ...
                if (e.colIdx === 0) {
                    ...
                    e.record.data['nivel_act_kms_total_anno_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_total_anno_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                    DistribuirCMN(e, consumido);
                }
                if (e.colIdx === 0 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_ene_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_ene_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 1 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_feb_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_feb_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 2 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_mar_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_mar_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 3 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_abr_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_abr_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 4 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_may_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_may_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 5 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_jun_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_jun_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 6 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_jul_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_jul_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 7 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_ago_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_ago_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 8 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_sep_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_sep_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 9 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_oct_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_oct_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 10 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_nov_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_nov_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 11 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_dic_mn'] = Ext.util.Format.round(e.record.data['combustible_litros_dic_mn'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                ...
                if (e.colIdx === 1) {
                    ...
                    e.record.data['nivel_act_kms_total_anno_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_total_anno_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                    DistribuirCCUC(e, consumido);
                }
                if (e.colIdx === 0 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_ene_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_ene_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 1 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_feb_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_feb_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 2 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_mar_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_mar_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 3 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_abr_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_abr_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 4 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_may_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_may_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 5 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_jun_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_jun_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 6 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_jul_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_jul_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 7 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_ago_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_ago_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 8 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_sep_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_sep_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 9 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_oct_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_oct_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 10 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_nov_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_nov_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                if (e.colIdx === 11 * nindicador + ncolanteriores) {
                    e.record.data['nivel_act_kms_dic_cuc'] = Ext.util.Format.round(e.record.data['combustible_litros_dic_cuc'] * 100 / e.record.data['vehiculo_norma'], 2);
                }
                ...
                if (e.colIdx === 3) {
                    ...
                    e.record.data['combustible_litros_total_anno_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_total_anno_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                    DistribuirKMMN(e, consumido);
                }
                if (e.colIdx === 0 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_ene_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_ene_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 1 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_feb_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_feb_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 2 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_mar_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_mar_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 3 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_abr_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_abr_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 4 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_may_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_may_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 5 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_jun_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_jun_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 6 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_jul_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_jul_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 7 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_ago_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_ago_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 8 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_sep_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_sep_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 9 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_oct_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_oct_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 10 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_nov_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_nov_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 11 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_dic_mn'] = Ext.util.Format.round(e.record.data['nivel_act_kms_dic_mn'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                ...
                if (e.colIdx === 4) {
                    ...
                    e.record.data['combustible_litros_total_anno_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_total_anno_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                    DistribuirKMCUC(e, consumido);
                }
                if (e.colIdx === 0 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_ene_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_ene_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 1 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_feb_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_feb_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 2 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_mar_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_mar_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 3 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_abr_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_abr_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 4 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_may_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_may_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 5 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_jun_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_jun_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 6 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_jul_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_jul_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 7 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_ago_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_ago_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 8 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_sep_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_sep_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 9 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_oct_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_oct_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 10 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_nov_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_nov_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
                if (e.colIdx === 11 * nindicador + ncolanteriores) {
                    e.record.data['combustible_litros_dic_cuc'] = Ext.util.Format.round(e.record.data['nivel_act_kms_dic_cuc'] * e.record.data['vehiculo_norma'] / 100, 2);
                }
        ...
        columns: [
            ...
            },
            {
                ...
                columns: [
                    {
                        xtype: 'gridcolumn',
                        text: '<div style="text-align: center"><b>Comb. MEP</b></div>',
                        width: 100,
                    ...
                    {
                        xtype: 'gridcolumn',
                        text: '<div style="text-align: center"><b>Comb. GAE</b></div>',
                        width: 100,
                    ...
                    },
                    {
                        ...
                        renderer: function (value, eOpts) {
                            eOpts.style = 'font-weight: bold;background: #cccccc; border: 1px solid #ffffff !important';
                            return Ext.String.format('<strong>{0}</strong>', Ext.util.Format.round(value, 2));
                        }
                    },
                    {
                        xtype: 'gridcolumn',
                        text: '<div style="text-align: center"><b>Kms. MEP</b></div>',
                        width: 100,
                    ...
                    {
                        xtype: 'gridcolumn',
                        text: '<div style="text-align: center"><b>Kms. GAE</b></div>',
                        width: 100,
...
ConsumidoCMN = function (e) {
    ...
    if (parseInt(App.current_month) > 1) consumido += e.record.data['combustible_litros_ene_mn'];
    if (parseInt(App.current_month) > 2) consumido += e.record.data['combustible_litros_feb_mn'];
    if (parseInt(App.current_month) > 3) consumido += e.record.data['combustible_litros_mar_mn'];
    if (parseInt(App.current_month) > 4) consumido += e.record.data['combustible_litros_abr_mn'];
    if (parseInt(App.current_month) > 5) consumido += e.record.data['combustible_litros_may_mn'];
    if (parseInt(App.current_month) > 6) consumido += e.record.data['combustible_litros_jun_mn'];
    if (parseInt(App.current_month) > 7) consumido += e.record.data['combustible_litros_jul_mn'];
    if (parseInt(App.current_month) > 8) consumido += e.record.data['combustible_litros_ago_mn'];
    if (parseInt(App.current_month) > 9) consumido += e.record.data['combustible_litros_sep_mn'];
    if (parseInt(App.current_month) > 10) consumido += e.record.data['combustible_litros_oct_mn'];
    if (parseInt(App.current_month) > 11) consumido += e.record.data['combustible_litros_nov_mn'];
    if (parseInt(App.current_month) > 12) consumido += e.record.data['combustible_litros_dic_mn'];
...
DistribuirCMN = function (e, consumido) {
    ...
    var monto_distribuir = Math.floor((e.record.data['combustible_litros_total_anno_mn'] - consumido) / (13 - parseInt(App.current_month)));
    var resto_distribuir = (e.record.data['combustible_litros_total_anno_mn'] - consumido) % (13 - parseInt(App.current_month));

    if (parseInt(App.current_month) <= 1) e.record.data['combustible_litros_ene_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 2) e.record.data['combustible_litros_feb_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 3) e.record.data['combustible_litros_mar_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 4) e.record.data['combustible_litros_abr_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 5) e.record.data['combustible_litros_may_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 6) e.record.data['combustible_litros_jun_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 7) e.record.data['combustible_litros_jul_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 8) e.record.data['combustible_litros_ago_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 9) e.record.data['combustible_litros_sep_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 10) e.record.data['combustible_litros_oct_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 11) e.record.data['combustible_litros_nov_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 12) e.record.data['combustible_litros_dic_mn'] = monto_distribuir + resto_distribuir;
    ...
    if (parseInt(App.current_month) <= 1) e.record.data['nivel_act_kms_ene_mn'] = monto;
    if (parseInt(App.current_month) <= 2) e.record.data['nivel_act_kms_feb_mn'] = monto;
    if (parseInt(App.current_month) <= 3) e.record.data['nivel_act_kms_mar_mn'] = monto;
    if (parseInt(App.current_month) <= 4) e.record.data['nivel_act_kms_abr_mn'] = monto;
    if (parseInt(App.current_month) <= 5) e.record.data['nivel_act_kms_may_mn'] = monto;
    if (parseInt(App.current_month) <= 6) e.record.data['nivel_act_kms_jun_mn'] = monto;
    if (parseInt(App.current_month) <= 7) e.record.data['nivel_act_kms_jul_mn'] = monto;
    if (parseInt(App.current_month) <= 8) e.record.data['nivel_act_kms_ago_mn'] = monto;
    if (parseInt(App.current_month) <= 9) e.record.data['nivel_act_kms_sep_mn'] = monto;
    if (parseInt(App.current_month) <= 10) e.record.data['nivel_act_kms_oct_mn'] = monto;
    if (parseInt(App.current_month) <= 11) e.record.data['nivel_act_kms_nov_mn'] = monto;
    if (parseInt(App.current_month) <= 12) e.record.data['nivel_act_kms_dic_mn'] = resto;
};
...
ConsumidoKMMN = function (e) {
    ...
    if (parseInt(App.current_month) > 1) consumido += e.record.data['nivel_act_kms_ene_mn'];
    if (parseInt(App.current_month) > 2) consumido += e.record.data['nivel_act_kms_feb_mn'];
    if (parseInt(App.current_month) > 3) consumido += e.record.data['nivel_act_kms_mar_mn'];
    if (parseInt(App.current_month) > 4) consumido += e.record.data['nivel_act_kms_abr_mn'];
    if (parseInt(App.current_month) > 5) consumido += e.record.data['nivel_act_kms_may_mn'];
    if (parseInt(App.current_month) > 6) consumido += e.record.data['nivel_act_kms_jun_mn'];
    if (parseInt(App.current_month) > 7) consumido += e.record.data['nivel_act_kms_jul_mn'];
    if (parseInt(App.current_month) > 8) consumido += e.record.data['nivel_act_kms_ago_mn'];
    if (parseInt(App.current_month) > 9) consumido += e.record.data['nivel_act_kms_sep_mn'];
    if (parseInt(App.current_month) > 10) consumido += e.record.data['nivel_act_kms_oct_mn'];
    if (parseInt(App.current_month) > 11) consumido += e.record.data['nivel_act_kms_nov_mn'];
    if (parseInt(App.current_month) > 12) consumido += e.record.data['nivel_act_kms_dic_mn'];
...
DistribuirKMMN = function (e, consumido) {
    ...
    var monto_distribuir = Math.floor((e.record.data['nivel_act_kms_total_anno_mn'] - consumido) / (13 - parseInt(App.current_month)));
    var resto_distribuir = (e.record.data['nivel_act_kms_total_anno_mn'] - consumido) % (13 - parseInt(App.current_month));

    if (parseInt(App.current_month) <= 1) e.record.data['nivel_act_kms_ene_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 2) e.record.data['nivel_act_kms_feb_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 3) e.record.data['nivel_act_kms_mar_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 4) e.record.data['nivel_act_kms_abr_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 5) e.record.data['nivel_act_kms_may_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 6) e.record.data['nivel_act_kms_jun_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 7) e.record.data['nivel_act_kms_jul_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 8) e.record.data['nivel_act_kms_ago_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 9) e.record.data['nivel_act_kms_sep_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 10) e.record.data['nivel_act_kms_oct_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 11) e.record.data['nivel_act_kms_nov_mn'] = monto_distribuir;
    if (parseInt(App.current_month) <= 12) e.record.data['nivel_act_kms_dic_mn'] = monto_distribuir + resto_distribuir;

    var monto = Ext.util.Format.round(monto_distribuir / e.record.data['vehiculo_norma'], 2);
    var resto = Ext.util.Format.round((monto_distribuir + resto_distribuir) / e.record.data['vehiculo_norma'], 2);

    if (parseInt(App.current_month) <= 1) e.record.data['combustible_litros_ene_mn'] = monto;
    if (parseInt(App.current_month) <= 2) e.record.data['combustible_litros_feb_mn'] = monto;
    if (parseInt(App.current_month) <= 3) e.record.data['combustible_litros_mar_mn'] = monto;
    if (parseInt(App.current_month) <= 4) e.record.data['combustible_litros_abr_mn'] = monto;
    if (parseInt(App.current_month) <= 5) e.record.data['combustible_litros_may_mn'] = monto;
    if (parseInt(App.current_month) <= 6) e.record.data['combustible_litros_jun_mn'] = monto;
    if (parseInt(App.current_month) <= 7) e.record.data['combustible_litros_jul_mn'] = monto;
    if (parseInt(App.current_month) <= 8) e.record.data['combustible_litros_ago_mn'] = monto;
    if (parseInt(App.current_month) <= 9) e.record.data['combustible_litros_sep_mn'] = monto;
    if (parseInt(App.current_month) <= 10) e.record.data['combustible_litros_oct_mn'] = monto;
    if (parseInt(App.current_month) <= 11) e.record.data['combustible_litros_nov_mn'] = monto;
    if (parseInt(App.current_month) <= 12) e.record.data['combustible_litros_dic_mn'] = resto;
};
...
ConsumidoCCUC = function (e) {
    ...
    if (parseInt(App.current_month) > 1) consumido += e.record.data['combustible_litros_ene_cuc'];
    if (parseInt(App.current_month) > 2) consumido += e.record.data['combustible_litros_feb_cuc'];
    if (parseInt(App.current_month) > 3) consumido += e.record.data['combustible_litros_mar_cuc'];
    if (parseInt(App.current_month) > 4) consumido += e.record.data['combustible_litros_abr_cuc'];
    if (parseInt(App.current_month) > 5) consumido += e.record.data['combustible_litros_may_cuc'];
    if (parseInt(App.current_month) > 6) consumido += e.record.data['combustible_litros_jun_cuc'];
    if (parseInt(App.current_month) > 7) consumido += e.record.data['combustible_litros_jul_cuc'];
    if (parseInt(App.current_month) > 8) consumido += e.record.data['combustible_litros_ago_cuc'];
    if (parseInt(App.current_month) > 9) consumido += e.record.data['combustible_litros_sep_cuc'];
    if (parseInt(App.current_month) > 10) consumido += e.record.data['combustible_litros_oct_cuc'];
    if (parseInt(App.current_month) > 11) consumido += e.record.data['combustible_litros_nov_cuc'];
    if (parseInt(App.current_month) > 12) consumido += e.record.data['combustible_litros_dic_cuc'];
...
DistribuirCCUC = function (e, consumido) {
    ...
    var monto_distribuir = Math.floor((e.record.data['combustible_litros_total_anno_cuc'] - consumido) / (13 - parseInt(App.current_month)));
    var resto_distribuir = (e.record.data['combustible_litros_total_anno_cuc'] - consumido) % (13 - parseInt(App.current_month));

    if (parseInt(App.current_month) <= 1) e.record.data['combustible_litros_ene_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 2) e.record.data['combustible_litros_feb_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 3) e.record.data['combustible_litros_mar_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 4) e.record.data['combustible_litros_abr_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 5) e.record.data['combustible_litros_may_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 6) e.record.data['combustible_litros_jun_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 7) e.record.data['combustible_litros_jul_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 8) e.record.data['combustible_litros_ago_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 9) e.record.data['combustible_litros_sep_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 10) e.record.data['combustible_litros_oct_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 11) e.record.data['combustible_litros_nov_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 12) e.record.data['combustible_litros_dic_cuc'] = monto_distribuir + resto_distribuir;

    var monto = Ext.util.Format.round(monto_distribuir * e.record.data['vehiculo_norma'], 2);
    var resto = Ext.util.Format.round((monto_distribuir + resto_distribuir) * e.record.data['vehiculo_norma'], 2);

    if (parseInt(App.current_month) <= 1) e.record.data['nivel_act_kms_ene_cuc'] = monto;
    if (parseInt(App.current_month) <= 2) e.record.data['nivel_act_kms_feb_cuc'] = monto;
    if (parseInt(App.current_month) <= 3) e.record.data['nivel_act_kms_mar_cuc'] = monto;
    if (parseInt(App.current_month) <= 4) e.record.data['nivel_act_kms_abr_cuc'] = monto;
    if (parseInt(App.current_month) <= 5) e.record.data['nivel_act_kms_may_cuc'] = monto;
    if (parseInt(App.current_month) <= 6) e.record.data['nivel_act_kms_jun_cuc'] = monto;
    if (parseInt(App.current_month) <= 7) e.record.data['nivel_act_kms_jul_cuc'] = monto;
    if (parseInt(App.current_month) <= 8) e.record.data['nivel_act_kms_ago_cuc'] = monto;
    if (parseInt(App.current_month) <= 9) e.record.data['nivel_act_kms_sep_cuc'] = monto;
    if (parseInt(App.current_month) <= 10) e.record.data['nivel_act_kms_oct_cuc'] = monto;
    if (parseInt(App.current_month) <= 11) e.record.data['nivel_act_kms_nov_cuc'] = monto;
    if (parseInt(App.current_month) <= 12) e.record.data['nivel_act_kms_dic_cuc'] = resto;
};
...
ConsumidoKMCUC = function (e) {
    ...
    if (parseInt(App.current_month) > 1) consumido += e.record.data['nivel_act_kms_ene_cuc'];
    if (parseInt(App.current_month) > 2) consumido += e.record.data['nivel_act_kms_feb_cuc'];
    if (parseInt(App.current_month) > 3) consumido += e.record.data['nivel_act_kms_mar_cuc'];
    if (parseInt(App.current_month) > 4) consumido += e.record.data['nivel_act_kms_abr_cuc'];
    if (parseInt(App.current_month) > 5) consumido += e.record.data['nivel_act_kms_may_cuc'];
    if (parseInt(App.current_month) > 6) consumido += e.record.data['nivel_act_kms_jun_cuc'];
    if (parseInt(App.current_month) > 7) consumido += e.record.data['nivel_act_kms_jul_cuc'];
    if (parseInt(App.current_month) > 8) consumido += e.record.data['nivel_act_kms_ago_cuc'];
    if (parseInt(App.current_month) > 9) consumido += e.record.data['nivel_act_kms_sep_cuc'];
    if (parseInt(App.current_month) > 10) consumido += e.record.data['nivel_act_kms_oct_cuc'];
    if (parseInt(App.current_month) > 11) consumido += e.record.data['nivel_act_kms_nov_cuc'];
    if (parseInt(App.current_month) > 12) consumido += e.record.data['nivel_act_kms_dic_cuc'];
...
DistribuirKMCUC = function (e, consumido) {
    ...
    var monto_distribuir = Math.floor((e.record.data['nivel_act_kms_total_anno_cuc'] - consumido) / (13 - parseInt(App.current_month)));
    var resto_distribuir = (e.record.data['nivel_act_kms_total_anno_cuc'] - consumido) % (13 - parseInt(App.current_month));

    if (parseInt(App.current_month) <= 1) e.record.data['nivel_act_kms_ene_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 2) e.record.data['nivel_act_kms_feb_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 3) e.record.data['nivel_act_kms_mar_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 4) e.record.data['nivel_act_kms_abr_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 5) e.record.data['nivel_act_kms_may_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 6) e.record.data['nivel_act_kms_jun_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 7) e.record.data['nivel_act_kms_jul_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 8) e.record.data['nivel_act_kms_ago_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 9) e.record.data['nivel_act_kms_sep_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 10) e.record.data['nivel_act_kms_oct_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 11) e.record.data['nivel_act_kms_nov_cuc'] = monto_distribuir;
    if (parseInt(App.current_month) <= 12) e.record.data['nivel_act_kms_dic_cuc'] = monto_distribuir + resto_distribuir;

    var monto = Ext.util.Format.round(monto_distribuir / e.record.data['vehiculo_norma'], 2);
    var resto = Ext.util.Format.round((monto_distribuir + resto_distribuir) / e.record.data['vehiculo_norma'], 2);

    if (parseInt(App.current_month) <= 1) e.record.data['combustible_litros_ene_cuc'] = monto;
    if (parseInt(App.current_month) <= 2) e.record.data['combustible_litros_feb_cuc'] = monto;
    if (parseInt(App.current_month) <= 3) e.record.data['combustible_litros_mar_cuc'] = monto;
    if (parseInt(App.current_month) <= 4) e.record.data['combustible_litros_abr_cuc'] = monto;
    if (parseInt(App.current_month) <= 5) e.record.data['combustible_litros_may_cuc'] = monto;
    if (parseInt(App.current_month) <= 6) e.record.data['combustible_litros_jun_cuc'] = monto;
    if (parseInt(App.current_month) <= 7) e.record.data['combustible_litros_jul_cuc'] = monto;
    if (parseInt(App.current_month) <= 8) e.record.data['combustible_litros_ago_cuc'] = monto;
    if (parseInt(App.current_month) <= 9) e.record.data['combustible_litros_sep_cuc'] = monto;
    if (parseInt(App.current_month) <= 10) e.record.data['combustible_litros_oct_cuc'] = monto;
    if (parseInt(App.current_month) <= 11) e.record.data['combustible_litros_nov_cuc'] = monto;
    if (parseInt(App.current_month) <= 12) e.record.data['combustible_litros_dic_cuc'] = resto;
};
