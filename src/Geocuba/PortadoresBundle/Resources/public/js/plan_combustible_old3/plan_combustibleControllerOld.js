    ...
    var store_planificacion_combustible = Ext.create('Ext.data.JsonStore', {
        ...
        listeners: {
            ...
            load: function (This, records, successful, eOpts) {
                ...
                if (App.current_year == App.selected_year) {
    ...
    var edit = new Ext.grid.plugin.CellEditing({
        ...
        listeners: {
            beforeedit: function (This, e, eOpts) {
                ...
                console.log(Ext.getCmp('fieldMesId').getValue().toLowerCase());

                let meses = ['ene', 'feb', 'mar', 'abr', 'may', 'jun', 'jul', 'ago', 'sep', 'oct', 'nov', 'dic', 'anno'];

                let monthIdx = meses.findIndex(m => m === Ext.getCmp('fieldMesId').getValue().toLowerCase()) + 1;

                if (e.grid.store.data.items[e.rowIdx].data.aprobada && monthIdx < App.selected_month) {
                    return false;
                }
                ...
                var ncolanteriores = 8;
                var nindicador = 4;
                // if (e.colIdx > 7 && (e.colIdx < (App.selected_month - 1) * nindicador + ncolanteriores) || isNaN(e.value)) {
                //     console.log('c');
                //     return false;
                // }
            ...
            edit: function (This, e, eOpts) {
                ...
                if (e.colIdx == 0) {
                    ...
                    if (e.record.data['aprobada']){
                        meses.forEach((m, index) => {
                            if (index < App.selected_month-1)
                            consumido += e.record.data['combustible_litros_' + m]
                        })
                    }
                ...
                ncolanteriores = 19;
                if (e.colIdx == 1) {
                    // var consumido = e.record.data['nivel_act_kms_total_mn'];
                    var consumido = 0;
                    if (e.record.data['aprobada']){
                        meses.forEach((m, index) => {
                            if (index < App.selected_month-1)
                                consumido += e.record.data['nivel_act_kms_' + m]
                        })
                    }
                ...
                if (e.colIdx % nindicador != 6 && e.colIdx % nindicador != 7) {
                    ...
                    e.record.data['lubricante_total_anno'] = Ext.util.Format.round(e.record.data['combustible_litros_total_anno'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_total_anno'] = Ext.util.Format.round(e.record.data['combustible_litros_total_anno'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_ene'] = Ext.util.Format.round(e.record.data['combustible_litros_ene'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_ene'] = Ext.util.Format.round(e.record.data['combustible_litros_ene'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_feb'] = Ext.util.Format.round(e.record.data['combustible_litros_feb'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_feb'] = Ext.util.Format.round(e.record.data['combustible_litros_feb'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_mar'] = Ext.util.Format.round(e.record.data['combustible_litros_mar'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_mar'] = Ext.util.Format.round(e.record.data['combustible_litros_mar'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_abr'] = Ext.util.Format.round(e.record.data['combustible_litros_abr'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_abr'] = Ext.util.Format.round(e.record.data['combustible_litros_abr'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_may'] = Ext.util.Format.round(e.record.data['combustible_litros_may'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_may'] = Ext.util.Format.round(e.record.data['combustible_litros_may'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_jun'] = Ext.util.Format.round(e.record.data['combustible_litros_jun'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_jun'] = Ext.util.Format.round(e.record.data['combustible_litros_jun'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_jul'] = Ext.util.Format.round(e.record.data['combustible_litros_jul'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_jul'] = Ext.util.Format.round(e.record.data['combustible_litros_jul'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_ago'] = Ext.util.Format.round(e.record.data['combustible_litros_ago'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_ago'] = Ext.util.Format.round(e.record.data['combustible_litros_ago'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_sep'] = Ext.util.Format.round(e.record.data['combustible_litros_sep'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_sep'] = Ext.util.Format.round(e.record.data['combustible_litros_sep'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_oct'] = Ext.util.Format.round(e.record.data['combustible_litros_oct'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_oct'] = Ext.util.Format.round(e.record.data['combustible_litros_oct'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_nov'] = Ext.util.Format.round(e.record.data['combustible_litros_nov'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_nov'] = Ext.util.Format.round(e.record.data['combustible_litros_nov'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                    ...
                    e.record.data['lubricante_dic'] = Ext.util.Format.round(e.record.data['combustible_litros_dic'] * e.record.data['vehiculo_norma_lubricante'], 4);
                    e.record.data['liquido_freno_dic'] = Ext.util.Format.round(e.record.data['combustible_litros_dic'] * e.record.data['vehiculo_norma_liquido_freno'], 4);
                }
        ...
        columns: [
            ...
            },
            {
                ...
                columns: [
                    ...
                    {
                        xtype: 'gridcolumn',
                        text: '<div style="text-align: center"><b>Kms</b></div>',
                        width: 85,
                    ...
                    },
                    {
                        ...
                        listeners: {
                            change: function (combo, newValue, oldValue, eOpts) {
                                if (newValue == 'Anno') {
                                    Ext.each(Ext.getCmp('fieldMesId').getStore().data.items, function (mes, index) {
...
ConsumidoCMN = function (e) {
    ...
    if (Ext.getCmp('fieldAnnoId').getValue() == App.current_year) {
        if (App.selected_month > 1) consumido += e.record.data['combustible_litros_ene_mn'];
        if (App.selected_month > 2) consumido += e.record.data['combustible_litros_feb_mn'];
        if (App.selected_month > 3) consumido += e.record.data['combustible_litros_mar_mn'];
        if (App.selected_month > 4) consumido += e.record.data['combustible_litros_abr_mn'];
        if (App.selected_month > 5) consumido += e.record.data['combustible_litros_may_mn'];
        if (App.selected_month > 6) consumido += e.record.data['combustible_litros_jun_mn'];
        if (App.selected_month > 7) consumido += e.record.data['combustible_litros_jul_mn'];
        if (App.selected_month > 8) consumido += e.record.data['combustible_litros_ago_mn'];
        if (App.selected_month > 9) consumido += e.record.data['combustible_litros_sep_mn'];
        if (App.selected_month > 10) consumido += e.record.data['combustible_litros_oct_mn'];
        if (App.selected_month > 11) consumido += e.record.data['combustible_litros_nov_mn'];
        if (App.selected_month > 12) consumido += e.record.data['combustible_litros_dic_mn'];
    }
...
DistribuirCMN = function (e, consumido) {
    console.log(e.record.data['combustible_litros_total_anno_mn'])
    var meses = 0;

    if (e.record.data['aprobada'])
        meses = 13 - App.selected_month;
    else
        meses = 12;
    ...
    console.log(monto_distribuir);
    var resto_distribuir = (e.record.data['combustible_litros_total_anno_mn'] - consumido) % meses;
    console.log(resto_distribuir);

    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['combustible_litros_ene_mn'] = monto_distribuir;
        if (App.selected_month <= 2) e.record.data['combustible_litros_feb_mn'] = monto_distribuir;
        if (App.selected_month <= 3) e.record.data['combustible_litros_mar_mn'] = monto_distribuir;
        if (App.selected_month <= 4) e.record.data['combustible_litros_abr_mn'] = monto_distribuir;
        if (App.selected_month <= 5) e.record.data['combustible_litros_may_mn'] = monto_distribuir;
        if (App.selected_month <= 6) e.record.data['combustible_litros_jun_mn'] = monto_distribuir;
        if (App.selected_month <= 7) e.record.data['combustible_litros_jul_mn'] = monto_distribuir;
        if (App.selected_month <= 8) e.record.data['combustible_litros_ago_mn'] = monto_distribuir;
        if (App.selected_month <= 9) e.record.data['combustible_litros_sep_mn'] = monto_distribuir;
        if (App.selected_month <= 10) e.record.data['combustible_litros_oct_mn'] = monto_distribuir;
        if (App.selected_month <= 11) e.record.data['combustible_litros_nov_mn'] = monto_distribuir;
        if (App.selected_month <= 12) e.record.data['combustible_litros_dic_mn'] = monto_distribuir + resto_distribuir;
        console.log(e.record.data['combustible_litros_dic_mn']);
    } else {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['nivel_act_kms_ene_mn'] = monto;
        if (App.selected_month <= 2) e.record.data['nivel_act_kms_feb_mn'] = monto;
        if (App.selected_month <= 3) e.record.data['nivel_act_kms_mar_mn'] = monto;
        if (App.selected_month <= 4) e.record.data['nivel_act_kms_abr_mn'] = monto;
        if (App.selected_month <= 5) e.record.data['nivel_act_kms_may_mn'] = monto;
        if (App.selected_month <= 6) e.record.data['nivel_act_kms_jun_mn'] = monto;
        if (App.selected_month <= 7) e.record.data['nivel_act_kms_jul_mn'] = monto;
        if (App.selected_month <= 8) e.record.data['nivel_act_kms_ago_mn'] = monto;
        if (App.selected_month <= 9) e.record.data['nivel_act_kms_sep_mn'] = monto;
        if (App.selected_month <= 10) e.record.data['nivel_act_kms_oct_mn'] = monto;
        if (App.selected_month <= 11) e.record.data['nivel_act_kms_nov_mn'] = monto;
        if (App.selected_month <= 12) e.record.data['nivel_act_kms_dic_mn'] = resto;
    }
    else {
...
ConsumidoKMMN = function (e) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month > 1) consumido += e.record.data['nivel_act_kms_ene_mn'];
        if (App.selected_month > 2) consumido += e.record.data['nivel_act_kms_feb_mn'];
        if (App.selected_month > 3) consumido += e.record.data['nivel_act_kms_mar_mn'];
        if (App.selected_month > 4) consumido += e.record.data['nivel_act_kms_abr_mn'];
        if (App.selected_month > 5) consumido += e.record.data['nivel_act_kms_may_mn'];
        if (App.selected_month > 6) consumido += e.record.data['nivel_act_kms_jun_mn'];
        if (App.selected_month > 7) consumido += e.record.data['nivel_act_kms_jul_mn'];
        if (App.selected_month > 8) consumido += e.record.data['nivel_act_kms_ago_mn'];
        if (App.selected_month > 9) consumido += e.record.data['nivel_act_kms_sep_mn'];
        if (App.selected_month > 10) consumido += e.record.data['nivel_act_kms_oct_mn'];
        if (App.selected_month > 11) consumido += e.record.data['nivel_act_kms_nov_mn'];
        if (App.selected_month > 12) consumido += e.record.data['nivel_act_kms_dic_mn'];
    }
...
DistribuirKMMN = function (e, consumido) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['nivel_act_kms_ene_mn'] = monto_distribuir;
        if (App.selected_month <= 2) e.record.data['nivel_act_kms_feb_mn'] = monto_distribuir;
        if (App.selected_month <= 3) e.record.data['nivel_act_kms_mar_mn'] = monto_distribuir;
        if (App.selected_month <= 4) e.record.data['nivel_act_kms_abr_mn'] = monto_distribuir;
        if (App.selected_month <= 5) e.record.data['nivel_act_kms_may_mn'] = monto_distribuir;
        if (App.selected_month <= 6) e.record.data['nivel_act_kms_jun_mn'] = monto_distribuir;
        if (App.selected_month <= 7) e.record.data['nivel_act_kms_jul_mn'] = monto_distribuir;
        if (App.selected_month <= 8) e.record.data['nivel_act_kms_ago_mn'] = monto_distribuir;
        if (App.selected_month <= 9) e.record.data['nivel_act_kms_sep_mn'] = monto_distribuir;
        if (App.selected_month <= 10) e.record.data['nivel_act_kms_oct_mn'] = monto_distribuir;
        if (App.selected_month <= 11) e.record.data['nivel_act_kms_nov_mn'] = monto_distribuir;
        if (App.selected_month <= 12) e.record.data['nivel_act_kms_dic_mn'] = monto_distribuir + resto_distribuir;
    } else {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['combustible_litros_ene_mn'] = monto;
        if (App.selected_month <= 2) e.record.data['combustible_litros_feb_mn'] = monto;
        if (App.selected_month <= 3) e.record.data['combustible_litros_mar_mn'] = monto;
        if (App.selected_month <= 4) e.record.data['combustible_litros_abr_mn'] = monto;
        if (App.selected_month <= 5) e.record.data['combustible_litros_may_mn'] = monto;
        if (App.selected_month <= 6) e.record.data['combustible_litros_jun_mn'] = monto;
        if (App.selected_month <= 7) e.record.data['combustible_litros_jul_mn'] = monto;
        if (App.selected_month <= 8) e.record.data['combustible_litros_ago_mn'] = monto;
        if (App.selected_month <= 9) e.record.data['combustible_litros_sep_mn'] = monto;
        if (App.selected_month <= 10) e.record.data['combustible_litros_oct_mn'] = monto;
        if (App.selected_month <= 11) e.record.data['combustible_litros_nov_mn'] = monto;
        if (App.selected_month <= 12) e.record.data['combustible_litros_dic_mn'] = resto;
    } else {
...
ConsumidoCCUC = function (e) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month > 1) consumido += e.record.data['combustible_litros_ene_cuc'];
        if (App.selected_month > 2) consumido += e.record.data['combustible_litros_feb_cuc'];
        if (App.selected_month > 3) consumido += e.record.data['combustible_litros_mar_cuc'];
        if (App.selected_month > 4) consumido += e.record.data['combustible_litros_abr_cuc'];
        if (App.selected_month > 5) consumido += e.record.data['combustible_litros_may_cuc'];
        if (App.selected_month > 6) consumido += e.record.data['combustible_litros_jun_cuc'];
        if (App.selected_month > 7) consumido += e.record.data['combustible_litros_jul_cuc'];
        if (App.selected_month > 8) consumido += e.record.data['combustible_litros_ago_cuc'];
        if (App.selected_month > 9) consumido += e.record.data['combustible_litros_sep_cuc'];
        if (App.selected_month > 10) consumido += e.record.data['combustible_litros_oct_cuc'];
        if (App.selected_month > 11) consumido += e.record.data['combustible_litros_nov_cuc'];
        if (App.selected_month > 12) consumido += e.record.data['combustible_litros_dic_cuc'];
    }
...
DistribuirCCUC = function (e, consumido) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['combustible_litros_ene_cuc'] = monto_distribuir;
        if (App.selected_month <= 2) e.record.data['combustible_litros_feb_cuc'] = monto_distribuir;
        if (App.selected_month <= 3) e.record.data['combustible_litros_mar_cuc'] = monto_distribuir;
        if (App.selected_month <= 4) e.record.data['combustible_litros_abr_cuc'] = monto_distribuir;
        if (App.selected_month <= 5) e.record.data['combustible_litros_may_cuc'] = monto_distribuir;
        if (App.selected_month <= 6) e.record.data['combustible_litros_jun_cuc'] = monto_distribuir;
        if (App.selected_month <= 7) e.record.data['combustible_litros_jul_cuc'] = monto_distribuir;
        if (App.selected_month <= 8) e.record.data['combustible_litros_ago_cuc'] = monto_distribuir;
        if (App.selected_month <= 9) e.record.data['combustible_litros_sep_cuc'] = monto_distribuir;
        if (App.selected_month <= 10) e.record.data['combustible_litros_oct_cuc'] = monto_distribuir;
        if (App.selected_month <= 11) e.record.data['combustible_litros_nov_cuc'] = monto_distribuir;
        if (App.selected_month <= 12) e.record.data['combustible_litros_dic_cuc'] = monto_distribuir + resto_distribuir;
    } else {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['nivel_act_kms_ene_cuc'] = monto;
        if (App.selected_month <= 2) e.record.data['nivel_act_kms_feb_cuc'] = monto;
        if (App.selected_month <= 3) e.record.data['nivel_act_kms_mar_cuc'] = monto;
        if (App.selected_month <= 4) e.record.data['nivel_act_kms_abr_cuc'] = monto;
        if (App.selected_month <= 5) e.record.data['nivel_act_kms_may_cuc'] = monto;
        if (App.selected_month <= 6) e.record.data['nivel_act_kms_jun_cuc'] = monto;
        if (App.selected_month <= 7) e.record.data['nivel_act_kms_jul_cuc'] = monto;
        if (App.selected_month <= 8) e.record.data['nivel_act_kms_ago_cuc'] = monto;
        if (App.selected_month <= 9) e.record.data['nivel_act_kms_sep_cuc'] = monto;
        if (App.selected_month <= 10) e.record.data['nivel_act_kms_oct_cuc'] = monto;
        if (App.selected_month <= 11) e.record.data['nivel_act_kms_nov_cuc'] = monto;
        if (App.selected_month <= 12) e.record.data['nivel_act_kms_dic_cuc'] = resto;
    }
    else {
...
ConsumidoKMCUC = function (e) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month > 1) consumido += e.record.data['nivel_act_kms_ene_cuc'];
        if (App.selected_month > 2) consumido += e.record.data['nivel_act_kms_feb_cuc'];
        if (App.selected_month > 3) consumido += e.record.data['nivel_act_kms_mar_cuc'];
        if (App.selected_month > 4) consumido += e.record.data['nivel_act_kms_abr_cuc'];
        if (App.selected_month > 5) consumido += e.record.data['nivel_act_kms_may_cuc'];
        if (App.selected_month > 6) consumido += e.record.data['nivel_act_kms_jun_cuc'];
        if (App.selected_month > 7) consumido += e.record.data['nivel_act_kms_jul_cuc'];
        if (App.selected_month > 8) consumido += e.record.data['nivel_act_kms_ago_cuc'];
        if (App.selected_month > 9) consumido += e.record.data['nivel_act_kms_sep_cuc'];
        if (App.selected_month > 10) consumido += e.record.data['nivel_act_kms_oct_cuc'];
        if (App.selected_month > 11) consumido += e.record.data['nivel_act_kms_nov_cuc'];
        if (App.selected_month > 12) consumido += e.record.data['nivel_act_kms_dic_cuc'];
    }
...
DistribuirKMCUC = function (e, consumido) {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['nivel_act_kms_ene_cuc'] = monto_distribuir;
        if (App.selected_month <= 2) e.record.data['nivel_act_kms_feb_cuc'] = monto_distribuir;
        if (App.selected_month <= 3) e.record.data['nivel_act_kms_mar_cuc'] = monto_distribuir;
        if (App.selected_month <= 4) e.record.data['nivel_act_kms_abr_cuc'] = monto_distribuir;
        if (App.selected_month <= 5) e.record.data['nivel_act_kms_may_cuc'] = monto_distribuir;
        if (App.selected_month <= 6) e.record.data['nivel_act_kms_jun_cuc'] = monto_distribuir;
        if (App.selected_month <= 7) e.record.data['nivel_act_kms_jul_cuc'] = monto_distribuir;
        if (App.selected_month <= 8) e.record.data['nivel_act_kms_ago_cuc'] = monto_distribuir;
        if (App.selected_month <= 9) e.record.data['nivel_act_kms_sep_cuc'] = monto_distribuir;
        if (App.selected_month <= 10) e.record.data['nivel_act_kms_oct_cuc'] = monto_distribuir;
        if (App.selected_month <= 11) e.record.data['nivel_act_kms_nov_cuc'] = monto_distribuir;
        if (App.selected_month <= 12) e.record.data['nivel_act_kms_dic_cuc'] = monto_distribuir + resto_distribuir;
    }
    else {
    ...
    if (e.record.data['aprobada']) {
        if (App.selected_month <= 1) e.record.data['combustible_litros_ene_cuc'] = monto;
        if (App.selected_month <= 2) e.record.data['combustible_litros_feb_cuc'] = monto;
        if (App.selected_month <= 3) e.record.data['combustible_litros_mar_cuc'] = monto;
        if (App.selected_month <= 4) e.record.data['combustible_litros_abr_cuc'] = monto;
        if (App.selected_month <= 5) e.record.data['combustible_litros_may_cuc'] = monto;
        if (App.selected_month <= 6) e.record.data['combustible_litros_jun_cuc'] = monto;
        if (App.selected_month <= 7) e.record.data['combustible_litros_jul_cuc'] = monto;
        if (App.selected_month <= 8) e.record.data['combustible_litros_ago_cuc'] = monto;
        if (App.selected_month <= 9) e.record.data['combustible_litros_sep_cuc'] = monto;
        if (App.selected_month <= 10) e.record.data['combustible_litros_oct_cuc'] = monto;
        if (App.selected_month <= 11) e.record.data['combustible_litros_nov_cuc'] = monto;
        if (App.selected_month <= 12) e.record.data['combustible_litros_dic_cuc'] = resto;
    }
    else {
