...
Ext.onReady(function () {
    ...
    var store_destino = Ext.create('Ext.data.JsonStore', {
    ...
    var find_button = Ext.create('Ext.form.field.Text', {
        ...
        listeners: {
            render: function (field) {
                Ext.getCmp('id_grid_destino').getStore().on({
            ...
            change: function (field, newValue, oldValue, eOpt) {
                ...
                if (Ext.isEmpty(Ext.String.trim(field.getValue()))) {
                    ...
                    if (marked) {
                        Ext.getCmp('id_grid_destino').getStore().loadPage(1);
                    }
        ...
        triggers: {
            search: {
                ...
                handler: function () {
                    ...
                    if (!Ext.isEmpty(Ext.String.trim(value))) {
                        this.setMarked(true);
                        if (Ext.getCmp('id_grid_destino').getStore().getCount() > 0)
                            Ext.getCmp('id_grid_destino').getStore().loadPage(1, {params: {nombre: value}});
                    }
                }
            },
            clear: {
    ...
    var grid_destino = Ext.create('Ext.grid.Panel', {
        id: 'id_grid_destino',
        store: store_destino,
        columns: [
        ...
        listeners: {
            selectionchange: function (This, selected, e) {
                if(Ext.getCmp('destino_btn_mod'))
                Ext.getCmp('destino_btn_mod').setDisabled(selected.length == 0);
                if(Ext.getCmp('destino_btn_del'))
                Ext.getCmp('destino_btn_del').setDisabled(selected.length == 0);
            }
        }
    });

    var panel_destino = Ext.create('Ext.panel.Panel', {
        id: 'id_panel_destino',
        title: 'Destinos',
        frame: true,
        closable:true,
