...
Ext.onReady(function () {
    ...
    let storeDemandas = Ext.create('Ext.data.JsonStore', {
        storeId: 'storeAsignacionId',
        fields: [
            {name: 'id'},
            {name: 'tipo_combustible'},
        ...
        proxy: {
            type: 'ajax',
            url: App.buildURL('/portadores/asignacion/loadDemanda'),
            reader: {
                rootProperty: 'rows'
            }
        },
    ...
    let gridDemanda = Ext.create('Ext.grid.Panel', {
        id: 'gridDemanda',
        region: 'west',
        width: '25%',
    ...
    let store_disponible = Ext.create('Ext.data.JsonStore', {
    ...
    let grid = Ext.create('Ext.grid.Panel', {
        ...
        tbar: {
            id: 'Area_tbar',
            height: 36,
            items: [mes_anno,monedaCombo, tipo_combustible, btnClearSearch, '-']
        },
        // bbar: {
        //     xtype: 'pagingtoolbar',
        //     pageSize: 25,
    ...
    let grid_disponible = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {text: '<strong>Moneda</strong>', dataIndex: 'monedaNombre', flex: .8},
            {text: '<strong>Disponible</strong>', dataIndex: 'disponible', flex: .7, editor: 'numberfield',},
        ],
        tbar: {
            id: 'cdt_tbar',
            height: 36,
            items: [
                {
                    ...
                    handler: function (This, e) {
                        ...
                        Ext.Msg.show({
                            ...
                            fn: function (btn) {
                                if (btn === 'yes') {
                                    App.request('POST', App.buildURL('/portadores/plan_disponible/modDisponible'), {
                                        unidadid: unidadid,
                                        store: store_send
    ...
    let _panel = Ext.create('Ext.panel.Panel', {
        ...
        layout: 'border',
        padding: '1 0 0',
        items: [panetree, gridDemanda, grid, grid_disponible]
    });
    App.render(_panel);
});