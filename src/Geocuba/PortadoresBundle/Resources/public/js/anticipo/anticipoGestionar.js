...
Ext.onReady(function () {
    ...
    // Ext.define('Portadores.liq.Window', {
    //     extend: 'Ext.window.Window',
    //     width: 800,
    //     height: 600,
    //     modal: true,
                        ...
                        buttons: [
                            {
                                ...
                                handler: function () {
                                    ...
                                    if (form.isValid()) {
                                        ...
                                        obj.cantAnt = parseFloat(selection.data.cantidad);
    ...
    //     ftype: 'grouping'
    // });
    // let groupingFeature1 = Ext.create('Ext.grid.feature.Grouping', {
    //     groupHeaderTpl: '<b>Tarjeta: {name} ' + ' ({rows.length})</b>',
    //     hideGroupedHeader: true,
    //     startCollapsed: false,
    //     ftype: 'grouping'
    ...
    //     proxy: {
    //         type: 'ajax',
    //         url: App.buildURL('/portadores/anticipo/loadLiqRest'),
    //         reader: {
    //             rootProperty: 'rows',
    //             sortRoot: 'id'
    //         }
    ...
    // let btn_ant_restaurar = Ext.create('Ext.button.MyButton', {
    //     id: 'btn_ant_restaurar',
    //     tooltip: 'Anticipos y recargas eliminados pendientes',
    //     disabled: true,
    //     glyph: 0xf071,
    //     handler: function (This, e) {
    //         Ext.create('Ext.window.Window', {
    //             title: 'Anticipos y recargas eliminados del historial de tarjeta',
    //             id: 'win_ant_del_id',
    //             height: 600,
    //             width: 1024,
    //             modal: true,
    ...
    //
    //                                         let window_mod = Ext.create('Portadores.anticipo.Window', {
    ...
    //                                                             App.request('POST', App.buildURL('/portadores/anticipo/modAntRest'), obj, null, null,
    //                                                                 function (response) { // success_callback
    //                                                                     if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    //                                                                         firstTime = true;
    //                                                                         window_mod.close();
    ...
    //                                                                 obj.id = selection.data.id;
    //                                                                 obj.consecutivo = selection.data.consecutivo;
    //                                                                 App.request('POST', App.buildURL('/portadores/anticipo/restaurar'), obj, null, null,
    //                                                                     function (response) { // success_callback
    //                                                                         if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    //                                                                             firstTime = true;
    //                                                                             window.close();
    ...
    //                                             fn: function (btn) {
    //                                                 if (btn === 'yes') {
    //                                                     App.request('POST', App.buildURL('/portadores/anticipo/descartarAnt'),
    ...
    //                                             fn: function (btn) {
    //                                                 if (btn === 'yes') {
    //                                                     App.request('POST', App.buildURL('/portadores/anticipo/desmarcarAnt'),
    //                                                         {id: selection.data.id}, null, null, function (response) { // success_callback
    //                                                             if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    //                                                                 Ext.getCmp('grid_ant_del').getStore().reload();
    ...
    //                                             }
    //                                         });
    //                                         Ext.create('Portadores.liq.Window', {
    //                                             title: 'Liquidación',
    //                                             id: 'window_liq_id',
    //                                             buttons: [
    //                                                 {
    ...
    //                                                             window.hide();
    //                                                             App.request('POST', App.buildURL('/portadores/anticipo/addLiqToRestore'), obj, null, null,
    //                                                                 function (response) {
    //                                                                     if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    //                                                                         form.reset();
    ...
    //
    //                                                         App.request('POST', App.buildURL('/portadores/anticipo/restaurarRec'), obj, null, null,
    //                                                             function (response) { // success_callback
    //                                                                 if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    //                                                                     firstTime = true;
    ...
    //                                         fn: function (btn) {
    //                                             if (btn === 'yes') {
    //                                                 App.request('POST', App.buildURL('/portadores/anticipo/descartarRec'),
    //                                                     {id: selection.data.id}, null, null, function (response) { // success_callback
    //                                                         if (response && response.hasOwnProperty('success') && response.success) { // success_callback but check if exists errors
    ...
    //                         Ext.getCmp('id_grid_anticipo').getStore().load();
    //                         Ext.getCmp('grid_ant_del').getStore().load();
    //                         Ext.getCmp('win_ant_del_id').close();
    //                     }
    //                 }
    //             ]
    //         }).show();
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        if (selected !== undefined) {
                            ...
                            if (Ext.util.Format.round(total_combustible,2) > Ext.util.Format.round(selected.data.cantidad,2)) {
                                App.showAlert('Las liquidaciones exceden la cantidad de litros del Anticipo', 'danger');
                                return;
                            }
