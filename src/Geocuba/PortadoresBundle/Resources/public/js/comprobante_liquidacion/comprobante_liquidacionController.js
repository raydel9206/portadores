Ext.onReady(function(){
        ...
        listeners: {
            boxready: function () {
                ...
                let assignGridPromise = new Promise((resolve, reject) => {
                    let i = 0;
                    while(!Ext.getCmp('id_grid_comp_liq') && i < 5){
                        setTimeout(() => { i++; }, 1000);
                    }
                    resolve(Ext.getCmp('id_grid_comp_liq'));
                });
    ...
    let store = Ext.create('Ext.data.JsonStore', {
        ...
        proxy: {
            type: 'ajax',
            url: App.buildURL('portadores/comp_liq/load'),
            reader: {
                rootProperty: 'rows'
            }
        },
        ...
        listeners: {
            beforeload: function (This, operation, eOpts) {
                grid_comp_liq.getSelectionModel().deselectAll();
                operation.setParams({
    ...
    let _btn_Export = Ext.create('Ext.button.MyButton', {
        ...
        handler: function (This, e) {
            ...
            // obj.accion = true;
            //
            App.request('POST', App.buildURL('/portadores/comp_liq/export'), obj, null, null,
    ...
    var grid_comp_liq = Ext.create('Ext.grid.Panel',{
        id: 'id_grid_comp_liq',
        disabled: true,
        region: 'center',
        store: store,
    ...
    var _panel_comp_liq = Ext.create('Ext.panel.Panel',{
        id: 'id_panel_comp_liq',
        title: 'Comprobante de Operaciones - Liquidaciones',
        frame : true,
        closable:true,
        layout: 'border',
        items:[panetree,grid_comp_liq]
    });
    App.render(_panel_comp_liq);
});