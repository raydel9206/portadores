...
Ext.onReady(function(){
    var find_button = Ext.create('Ext.form.field.Text', {
        ...
        listeners: {
            render: function (field) {
                Ext.getCmp('id_grid_moneda').getStore().on({
            ...
            change: function (field, newValue, oldValue, eOpt) {
                ...
                if (Ext.isEmpty(Ext.String.trim(field.getValue()))) {
                    ...
                    if (marked) {
                        Ext.getCmp('id_grid_moneda').getStore().loadPage(1);
                    }
        ...
        triggers: {
            search: {
                ...
                handler: function () {
                    ...
                    if (!Ext.isEmpty(Ext.String.trim(value))) {
                        this.setMarked(true);
                        if (Ext.getCmp('id_grid_moneda').getStore().getCount() > 0)
                            Ext.getCmp('id_grid_moneda').getStore().loadPage(1, {params: {nombre: value}});
                    }
                }
            },
            clear: {
    ...
    var grid_moneda = Ext.create('Ext.grid.Panel',{
        id: 'id_grid_moneda',
       ...
       bbar: {
           xtype: 'pagingtoolbar',
           pageSize: 25,
           store: Ext.getStore('id_store_moneda'),
           displayInfo: true,
        ...
        listeners: {
            selectionchange: function(This, selected, e){
                Ext.getCmp('moneda_tbar').items.each(
    ...
    var _panel_moneda = Ext.create('Ext.panel.Panel',{
        id: 'id_panel_moneda',
