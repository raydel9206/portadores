...
class PlanCombustibleController extends Controller
{
    ...
    public function loadAction(Request $request)
    {
        ...
        $fechaDesde = $_anno . '-' .'01-01 00:00:00';
        $fechaHasta = FechaUtil::getUltimoDiaMes(12, $_anno);
...
//                + $entityMN->getLubricanteDic();
            ...
            $combustible_litros_total_mn = (float)$em->getRepository('PortadoresBundle:Liquidacion')->consumoVehiculo($entityMN->getVehiculoid()->getId(), $entityMN->getVehiculoid()->getNtipoCombustibleid()->getId(), $fechaDesde, $fechaHasta, $em->getRepository('PortadoresBundle:Moneda')->findOneBy(array('nombre'=>'CUP','visible'=>true)));
            //TODO Cojer Por Anexo Unico
            $nivel_act_kms_total_mn = $combustible_litros_total_mn * $entityMN->getVehiculoid()->getNorma();
            $lubricante_total = $combustible_litros_total_mn * 0.015;
            $liquido_freno_total = $combustible_litros_total_mn * 0.00015;
...
//                + $entityCUC->getNivelActKmsDic();
            ...
            //TODO Cuando piensas que lo haz visto todo
            $norma = '-';
            if ($entityMN->getVehiculoid()->getNorma())
                $norma = $entityMN->getVehiculoid()->getNorma();
            elseif ($entityMN->getVehiculoid()->getNorma())
...
//        $_vehiculo = trim($request->get('vehiculo'));
        ...
        <table cellspacing='0' cellpadding='5' border='1' width='100%'>
            ...
            <tr>
            <td colspan='3' style='border: none;'></td>
            <td colspan='3' style='border: none;'><div style='text-align:left; font-size: 14px;'><strong>Combustible: </strong>" . $tipoCombustible->getNombre() . "</div></td>
            ...
            switch ($_opcion) {
                case 1:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosEne() + $entityCUC->getCombustibleLitrosEne()) . "</td>
                                ...
                                <td style='text-align: center;'>" . $entityMN->getLubricanteEne() . "</td>
                ...
                case 2:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosFeb() + $entityCUC->getCombustibleLitrosFeb()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsFeb() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteFeb() . "</td>
                ...
                case 3:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosMar() + $entityCUC->getCombustibleLitrosMar()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsMar() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteMar() . "</td>
                ...
                case 4:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosAbr() + $entityCUC->getCombustibleLitrosAbr()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsAbr() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteAbr() . "</td>
                ...
                case 5:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosMay() + $entityCUC->getCombustibleLitrosMay()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsMay() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteMay() . "</td>
                ...
                case 6:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosJun() + $entityCUC->getCombustibleLitrosJun()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsJun() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteJun() . "</td>
                ...
                case 7:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosJul() + $entityCUC->getCombustibleLitrosJul()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsJul() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteJul() . "</td>
                ...
                case 8:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosAgo() + $entityCUC->getCombustibleLitrosAgo()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsAgo() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteAgo() . "</td>
                ...
                case 9:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosSep() + $entityCUC->getCombustibleLitrosSep()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsSep() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteSep() . "</td>
                ...
                case 10:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosOct() + $entityCUC->getCombustibleLitrosOct()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsOct() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteOct() . "</td>
                ...
                case 11:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosNov() + $entityCUC->getCombustibleLitrosNov()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsNov() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteNov() . "</td>
                ...
                case 12:
                    ...
                    $_html .= "<tr>
                                ...
                                <td style='text-align: center;'>" . $tipoCombustible->getPrecio() * ($entityMN->getCombustibleLitrosDic() + $entityCUC->getCombustibleLitrosDic()) . "</td>
                                <td style='text-align: center;'>" . $norma . "</td>
                                <td style='text-align: center;'>" . $entityMN->getNivelActKmsDic() . "</td>
                                <td style='text-align: center;'>" . $indice . "</td>
                                <td style='text-align: center;'>" . $entityMN->getLubricanteDic() . "</td>
        ...
        $_html .= "<tr>
                    ...
                    <td style='text-align: center;'><strong>" . $tipoCombustible->getPrecio() * ($combmnt + $combcuct) . "</strong></td>
        ...
        $pieFirma = $this->get('portadores.piefirma')->getPieFirma(DocumentosEnum::planCombustible);
        $_html .= "<tr>
