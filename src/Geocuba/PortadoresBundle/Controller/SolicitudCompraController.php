    ...
    public function loadDesgloseAction(Request $request)
    {
        ...
        foreach ($entities as $entity) {
            ...
            if ($desglose1 || $desglose2) {
                ...
                $disponible_fincimex = Datos::getPlanDisponibleFincimex($em, $nunidadid, $entity, null);

                //Obtener Saldo Fincimex
                $saldo_fincimex = Datos::getSaldoDisponibleFincimex($em, $nunidadid, $entity,null);

                //Obtener Saldo caja
                $saldo_caja = Datos::getSaldoCaja($em, $nunidadid, $entity,null);
