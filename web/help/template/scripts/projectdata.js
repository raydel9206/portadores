...
rh.consts('DEFAULT_TOPIC', encodeURI("#Proceso_SIG_Portadores_Energéticos.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '01A85675-D70B-4CD4-9C2A-07F9302015AC' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "SIG Portadores Energéticos");
model.publish(rh.consts('KEY_HEADER_TITLE_COLOR'), "#000000");
model.publish(rh.consts('KEY_HEADER_BACKGROUND_COLOR'), "#EEEEEE");
model.publish(rh.consts('KEY_HEADER_LOGO_PATH'), "template/Charcoal_Grey1/logo.png");
model.publish(rh.consts('KEY_LAYOUT_FONT_FAMILY'), "Comic Sans MS");
